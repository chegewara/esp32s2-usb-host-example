                                     ...
                                     int num_xfers)
{
    ...
    hcd_pipe_config_t config = {
        ...
        .context = NULL,
        .ep_desc = USB_XFER_TYPE_INTR,    //NULL EP descriptor to create a default pipe
        .dev_addr = 0,
                                    ...
                                    int num_xfers)
{
    ...
    do{ // do we really need this?
        hcd_xfer_req_handle_t req_hdl = hcd_xfer_req_dequeue(ctrl_pipe_hdl);
        hcd_pipe_handle_t pipe_hdl;
        usb_irp_t *irp;
        void *context;
